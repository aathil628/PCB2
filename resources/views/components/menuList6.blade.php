            ...
            <div class="main-menu__wrapper-inner">
                ...
                <div class="main-menu__main-menu-box">
                    ...
                    <ul class="main-menu__list">
                        <li class="dropdown megamenu {{ request()->routeIs('index*') ? 'current' : '' }}">
                            <a href={{ url('/') }}>Home </a>
                            <ul>
                                <li>
                        ...
                        <li class="dropdown {{ request()->routeIs('instructor*') || request()->routeIs('events*') || request()->routeIs('pricing') || request()->routeIs('gallery') || request()->routeIs('faq') ? 'current' : '' }}">
                            <a href={{ url('#') }}>Pages</a>
                            <ul class="shadow-box">
                        ...
                        <li class="dropdown {{ request()->routeIs('products') || request()->routeIs('product-details') || request()->routeIs('cart') || request()->routeIs('checkout') || request()->routeIs('wishlist') ? 'current' : '' }}">
                            <a href={{ url('#') }}>Shop</a>
                            <ul class="shadow-box">
